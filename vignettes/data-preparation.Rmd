...
Les variables discrètes et continues ne doivent être précisées que si la fonction `classify_variables` identifie mal leur type. Cette fonction détermine automatiquement le type de chaque variable, à partir du format et du nombre de modalités. Le seuil de classification d’une variable comme catégorielle est fixé par défaut à 15.
...
Il est également possible de gérer une arborescence complète d’enquêtes, avec plusieurs niveaux hiérarchiques. Voici un exemple de structure de fichiers attendue :
...
Enfin, l’interface est lancée à la même profondeur :
